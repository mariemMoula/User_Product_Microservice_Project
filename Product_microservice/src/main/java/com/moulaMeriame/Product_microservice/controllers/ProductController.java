...
public class ProductController {
    ...
    @Retry(name = "productmicroService", fallbackMethod = "fallback")
    @RateLimiter(name = "productmicroService", fallbackMethod = "fallback")    public List<Product> getAllProducts() {
    ...
    @CircuitBreaker(name = "productmicroService", fallbackMethod = "fallback")
    @Retry(name = "productmicroService", fallbackMethod = "fallback")
    @RateLimiter(name = "productmicroService", fallbackMethod = "fallback")    public ResponseEntity<Product> getProductById(@PathVariable Long id) {
    ...
    @CircuitBreaker(name = "productmicroService", fallbackMethod = "fallback")
    @Retry(name = "productmicroService", fallbackMethod = "fallback")
    @RateLimiter(name = "productmicroService", fallbackMethod = "fallback")    public ResponseEntity<Product> createProduct(@RequestBody Product product) {
    ...
    @CircuitBreaker(name = "productmicroService", fallbackMethod = "fallback")
    @Retry(name = "productmicroService", fallbackMethod = "fallback")
    @RateLimiter(name = "productmicroService", fallbackMethod = "fallback")
